...
-->
  ...
  <body>    
    <!-- Hero section -->
    <?php
      include_once "../2117_infinite_loop/parts/header.php";
      ?>
    ...
    <?php
        include_once "../2117_infinite_loop/parts/galeriaFunkcia.php"
    ?>


    <!-- Contact -->
    <?php
        include_once "../2117_infinite_loop/parts/footer.php"
        ?>
